...
| 103    | Não é possível realizar esta operação. (Tipo de token inválido.) | Não          | Não       | Verifique se o access_token informado foi gerado corretamente ou se possui permissões para executar a operação. | -           |
...
| 313    | Uma tentativa de resgate inválida com cartão de crédito foi efetuada. | Não          | Não       | -                                                            | Não         |
...
| 322    | Pagamento não autorizado.                                    | Não          | **Sim\*** | -                                                            | 422         |
...
A descrição das inconsistências serão listadas dentro da lista **sub**, dentro do objeto de retorno **errors**.    
O campo **subMessage**  será preenchido com a primeira inconsistência retornada, as informações serão exibidas da seguindo a formatação: .

| código do erro **322** concatenado com o type da primeira inconsistência (exemplo abaixo) |
| ------------------------------------------------------------ |
    ...
    "errors": [
        {
            ...
            "subMessage": "Número do endereço de entrega é obrigatório. (#322-25)",
            "sub": [
                {
                    "type": 25,
                    "message": "Número do endereço de entrega é obrigatório.",
                    "parameters": {}
                },
                {
                    "type": 45,
                    "message": "O Campo referência é obrigatório. (#322-45))",
                    "parameters": {}
                },
            ]
        }
...
| 25            | Número do endereço de entrega é obrigatório.                 |           |
...
| 41            | O campo complemento é obrigatório. Favor preencher (Ex: Casa/Loja) |           |
